...
public class PhieuMuonAdapter extends RecyclerView.Adapter<PhieuMuonAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PhieuMuonAdapter.ViewHolder holder, int position) {
        ...
        if(phieuMuon.getTraSach() == 1) {
            ...
            holder.tv_trangthai.setTextColor(context.getResources().getColor(R.color.vang));
        } else {
            holder.tv_trangthai.setText("Chưa trả sách");
            holder.tv_trangthai.setTextColor(context.getResources().getColor(R.color.hong));
